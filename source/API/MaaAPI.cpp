...
MaaControllerHandle MAA_API MaaThriftControllerCreate(MaaThriftControllerType type, MaaString param,
                                                      MaaControllerCallback callback,
                                                      MaaCallbackTransparentArg callback_arg)
{
    LogFunc << VAR(type) << VAR(param) << VAR_VOIDP(callback) << VAR_VOIDP(callback_arg);

    try {
        return new MAA_CTRL_NS::CustomThriftController(type, param, callback, callback_arg);
    }
